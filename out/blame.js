...
window.addEventListener("load", async () => {
  ...
  function showPopup(target) {
    ...
    if (!popupNode.popup) {
      ...
      linkBox.classList.add("blame-popup-link");
      popupNode.commitLink = document.createElement("a");
      popupNode.commitLink.textContent = "commit";
      linkBox.appendChild(document.createTextNode("Show "));
      linkBox.appendChild(popupNode.commitLink);

      popupNode.compareLink = document.createElement("a");
      popupNode.compareLink.textContent = "ecma262-compare";
      linkBox.appendChild(document.createTextNode(" or "));
      linkBox.appendChild(popupNode.compareLink);
